...
![How Bootloader works](../../../../assets/images/lab1/bootloader.png)

## Clone Lab1

![Create Github Codespace](../../../../assets/images/lab1/20260708151507.png)

- ให้ Clone Github Repository https://github.com/luckkrit/lab_cos3105
- ไปเปิดใน Github Codespace https://github.com/codespaces
...
1. compile boot.asm ไปเป็น boot.img
...
3. `CTRL + a + x` เพื่อทำการออกจาก QEMU