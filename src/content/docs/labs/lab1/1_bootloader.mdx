...
![Environment Variables](/cos3105/images/lab1/new_environment_variables_nasm.png)
</Steps>
...
2. เมื่อแปลงขนาด img ไฟล์ให้มีขนาดใหญ่ขึ้น ก็แปลงให้เป็น vdi ไฟล์
    ...
    ```
    ![Convert Image](/cos3105/images/lab1/convert_img.png)

3. เพิ่ม boot.vdi เข้าไปใน Hardisk
    ![Attach VDI](/cos3105/images/lab1/attach_vdi.png)
</Steps>
