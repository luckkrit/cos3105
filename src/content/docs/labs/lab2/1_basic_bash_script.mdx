---
title: Lab 2-1 - Basic Bash Script
...
![Shell Script](../../../../assets/images/lab2/shell_script.png)
...
|คำสั่ง|Linux|
|:--|:--|
|[display/output text](/cos3105/labs/lab2/1_basic_bash_script/#echo)|echo "hello world"|
|[create file](/cos3105/labs/lab2/1_basic_bash_script/#touch)|touch a.txt|
|[get content](/cos3105/labs/lab2/1_basic_bash_script/#cat)|cat a.txt <br/> more a.txt <br/> less a.txt|
|[clear console](/cos3105/labs/lab2/1_basic_bash_script/#clear)|clear|
|[copy file](/cos3105/labs/lab2/1_basic_bash_script/#cp)|cp a.txt b.txt|
|[move file](/cos3105/labs/lab2/1_basic_bash_script/#mv)|mv a.txt ../b.txt|
|[**delete file**](/cos3105/labs/lab2/1_basic_bash_script/#rm)|rm -i a.txt|
|[list directory](/cos3105/labs/lab2/1_basic_bash_script/#ls)|ls .|
|[list all files (include hidden)](/cos3105/labs/lab2/1_basic_bash_script/#ls)|ls -a|
|[create directory](/cos3105/labs/lab2/1_basic_bash_script/#mkdir)|mkdir my_folder|
|[**remove directory**](/cos3105/labs/lab2/1_basic_bash_script/#rm--ri)|rm -ri my_folder|
|[change directory](/cos3105/labs/lab2/1_basic_bash_script/#cd)|cd my_folder|
|[ดู manual/help ของคำสั่ง](/cos3105/labs/lab2/1_basic_bash_script/#man)|man ls|

#### echo

![echo](/cos3105/2_68/images/lab2/echo.gif)

#### touch

![touch](/cos3105/2_68/images/lab2/touch.gif)

#### cat

![cat](/cos3105/2_68/images/lab2/cat.gif)

#### clear

![clear](/cos3105/2_68/images/lab2/clear.gif)

#### mkdir

![mkdir](/cos3105/2_68/images/lab2/mkdir.gif)

#### cp

![cp](/cos3105/2_68/images/lab2/cp.gif)

#### mv
![mv](/cos3105/2_68/images/lab2/mv.gif)

#### rm
![rm](/cos3105/2_68/images/lab2/rm.gif)

#### ls
![ls](/cos3105/2_68/images/lab2/ls.gif)

#### rm -ri
![rm](/cos3105/2_68/images/lab2/rm_r.gif)

#### cd
![cd](/cos3105/2_68/images/lab2/cd.gif)

#### man
![man](/cos3105/2_68/images/lab2/man.gif)
...
การใช้งานตัวแปร environment (environment variable)
    ...
    ```bash
    //export_environment_variable.sh

    #!/bin/bash
    export NAME="Krit Chomaitong"
    ```

    แล้วในอีกไฟล์จะมีการเรียกใช้

    ```bash
    // call_environment_variable.sh

    #!/bin/bash
    source ./export_environment_variable.sh    
    echo 'call NAME='$NAME
    ```
    ...
    ```bash
    // export_environment_variable2.sh

    #!/bin/bash
    export NAME="Krit Chomaitong"
    echo 'export NAME='$NAME

    ./call_environment_variable2.sh    # NAME is inherited since call_environment_variable2.sh is a child process
    ```

    ไฟล์ที่มีการใช้ environment variable

    ```bash
    // call_environment_variable2.sh
...
- [integer](/cos3105/labs/lab2/1_basic_bash_script/#integer)

- [string](/cos3105/labs/lab2/1_basic_bash_script/#string)

- [file](/cos3105/labs/lab2/1_basic_bash_script/#file)

- [other](/cos3105/labs/lab2/1_basic_bash_script/#other)
