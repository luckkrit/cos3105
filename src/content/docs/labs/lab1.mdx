...
เดิมที่ค้างอยู่ต่อไปได้ เรื่องของ  Interrupt และเรื่องที่สัมพันธ์กันคือ  Trap และ Exception เป็นเรื่องที่มี
รายละเอียดมาก ซึ่งจะได้กล่าวถึงในรายละเอียดต่อไป
